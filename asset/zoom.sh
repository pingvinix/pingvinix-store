...
magick /tmp/description.png \
       ...
       -pointsize 16 -annotate +65+120 'Отмеченный наградами Zoom объединяет видеоконференции,
       онлайн-собрания и групповые сообщения в одно простое в использовании приложение.
       Единый корпоративный интерфейс для всех вариантов использования
